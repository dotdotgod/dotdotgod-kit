...
function buildLoadPrompt() {
  ...
  return `Load the dotdotgod project memory.\nCurrent working directory: ${root}\n\nDetected memory files:\n${presentText}\n\nMissing baseline files:\n${missingText}\n\nDocumentation map:\n${directorySummary}\n\nInstructions:\n1. Preserve user changes and do not modify project files.\n2. Use the documentation map as the shared project table of contents.\n3. Read AGENTS.md, README.md, and docs/README.md only when not already clear.\n4. Read document bodies selectively through README routing or focused query results.\n5. Inspect plan and archive local memory only when directly relevant.\n6. Report narrative project context rather than cache or graph statistics.`;
}
