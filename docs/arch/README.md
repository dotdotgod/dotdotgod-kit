...
- `IMPACT_GRAPH_EXPLORER.md`: local bounded impact graph delivery, seed/result separation, D3/Sigma rendering responsibilities, accessibility, and failure boundaries.
