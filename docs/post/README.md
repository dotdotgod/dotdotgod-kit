...
- `project-memory-from-biological-cognition/` — draft Korean and English editions explaining how dotdotgod turns explicit project memory into an impact-driven psychometry capability that traces changed files back to related review scope.
- `project-structure-as-ai-cognitive-cues/` — draft Korean and English editions arguing that effective AI use begins with human cognition and extends its reach across more information, relationships, and possibilities.
- `designing-project-memory-for-purpose/` — draft Korean Velog and English DEV Community editions explaining how dotdotgod projects define memory areas and relationships around the purposes of reading, investment analysis, and dispute resolution.
- `how-connected-memory-expands-project-cognition/` — draft Korean Velog and English DEV Community editions explaining how connected project memory develops more precise questions, knowledge boundaries, judgment criteria, and next actions.
- `what-to-practice-when-ai-writes-code/` — draft Korean and English editions explaining how AI lowers mechanical coding barriers while increasing the value of problem framing, code evaluation, design judgment, and complexity management.
