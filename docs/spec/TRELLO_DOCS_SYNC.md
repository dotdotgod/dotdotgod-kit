...
- Contracts:
  - `TRELLO-METADATA-001` — Frontmatter trelloUrl metadata is parsed, validated, and reported (sections: 1, impl: 1, verify: 1, docs: 1)
  - `TRELLO-SYNC-PATHS-001` — Configured sync paths use safe repository-relative pattern validation (sections: 1, impl: 2, verify: 1, docs: 2)
  - `TRELLO-GITHUB-URL-001` — Markdown files resolve to safe GitHub browser URLs without GitHub API calls (sections: 1, impl: 1, verify: 1, docs: 1)
  - `TRELLO-CREDENTIALS-001` — Write mode credentials are limited to trusted GitHub Actions environment secrets (sections: 1, impl: 3, verify: 2, docs: 1)
  - `TRELLO-WRITE-SURFACE-001` — Trusted write mode uses only the approved Trello REST surface (sections: 1, impl: 2, verify: 1, docs: 1)
  - `TRELLO-ATTACHMENT-001` — Attachment matching and creation use exact GitHub browser URLs (sections: 1, impl: 2, verify: 1, docs: 1)
  - `TRELLO-CUSTOM-FIELD-001` — dotdotgod-view custom field payloads preserve repository entries and conflict rules (sections: 1, impl: 3, verify: 1, docs: 1)
  - `TRELLO-TRACEABILITY-001` — Synced markdown traceability is summarized from canonical json dotdotgod blocks only (sections: 1, impl: 2, verify: 2, docs: 1)
  - `TRELLO-DUPLICATES-001` — Duplicate Trello short links block affected files without Trello API calls (sections: 1, impl: 1, verify: 1, docs: 1)
  - `TRELLO-REPORTS-001` — Human reports provide deterministic card status, warning, and action details (sections: 1, impl: 2, verify: 1, docs: 1)
  - `TRELLO-FAILURES-001` — Failure semantics and exit codes distinguish blocked, conflict, api-failed, and usage errors (sections: 2, impl: 3, verify: 2, docs: 1)
  - `TRELLO-POWER-UP-001` — Power-Up artifact displays dotdotgod-view custom field repository entries (sections: 3, impl: 2, verify: 2, docs: 1)

<!-- dotdotgod:traceability-links:end -->

```json dotdotgod
{"kind":"spec","implementedBy":["packages/cli/src/core.mjs","packages/cli/src/cli/usage.mjs","packages/cli/src/memory/config.mjs","packages/cli/src/trello/sync.mjs","packages/cli/src/trello/metadata.mjs","packages/cli/src/trello/github-url.mjs","packages/cli/src/trello/summary.mjs","packages/cli/src/trello/report.mjs","packages/cli/src/trello/client.mjs","packages/cli/src/trello/custom-fields.mjs","packages/trello-power-up/src/index.js",".github/workflows/trello-docs-sync.yml"],"verifiedBy":["packages/cli/test/trello-sync.test.mjs","packages/cli/test/trello-workflow.test.mjs","packages/cli/test/core.test.mjs","packages/trello-power-up/test/index.test.mjs","docs/test/TRELLO_DOCS_SYNC.md"],"relatedDocs":["docs/arch/TRELLO_DOCS_SYNC.md","docs/spec/CONFIG_COMMAND.md","docs/spec/VALIDATION_CONFIG.md","docs/test/CONFIG_COMMAND.md"],"verificationCommands":["node --test packages/cli/test/trello-sync.test.mjs packages/cli/test/trello-workflow.test.mjs","pnpm --filter @dotdotgod/cli test","pnpm --filter @dotdotgod/trello-power-up test","node packages/cli/bin/dotdotgod.mjs validate . --include-local-memory --check-index"],"contracts":[{"id":"TRELLO-METADATA-001","title":"Frontmatter trelloUrl metadata is parsed, validated, and reported","sections":["Markdown Metadata"],"implementedBy":["packages/cli/src/trello/metadata.mjs"],"verifiedBy":["packages/cli/test/trello-sync.test.mjs"],"relatedDocs":["docs/test/TRELLO_DOCS_SYNC.md"]},{"id":"TRELLO-SYNC-PATHS-001","title":"Configured sync paths use safe repository-relative pattern validation","sections":["Sync Paths"],"implementedBy":["packages/cli/src/memory/config.mjs","packages/cli/src/trello/sync.mjs"],"verifiedBy":["packages/cli/test/trello-sync.test.mjs"],"relatedDocs":["docs/spec/CONFIG_COMMAND.md","docs/spec/VALIDATION_CONFIG.md"]},{"id":"TRELLO-GITHUB-URL-001","title":"Markdown files resolve to safe GitHub browser URLs without GitHub API calls","sections":["GitHub URL Resolution"],"implementedBy":["packages/cli/src/trello/github-url.mjs"],"verifiedBy":["packages/cli/test/trello-sync.test.mjs"],"relatedDocs":["docs/arch/TRELLO_DOCS_SYNC.md"]},{"id":"TRELLO-CREDENTIALS-001","title":"Write mode credentials are limited to trusted GitHub Actions environment secrets","sections":["Credentials"],"implementedBy":["packages/cli/src/trello/sync.mjs","packages/cli/src/trello/client.mjs",".github/workflows/trello-docs-sync.yml"],"verifiedBy":["packages/cli/test/trello-sync.test.mjs","packages/cli/test/trello-workflow.test.mjs"],"relatedDocs":["docs/test/TRELLO_DOCS_SYNC.md"]},{"id":"TRELLO-WRITE-SURFACE-001","title":"Trusted write mode uses only the approved Trello REST surface","sections":["Trello Write Surface"],"implementedBy":["packages/cli/src/trello/sync.mjs","packages/cli/src/trello/client.mjs"],"verifiedBy":["packages/cli/test/trello-sync.test.mjs"],"relatedDocs":["docs/arch/TRELLO_DOCS_SYNC.md"]},{"id":"TRELLO-ATTACHMENT-001","title":"Attachment matching and creation use exact GitHub browser URLs","sections":["Attachment Semantics"],"implementedBy":["packages/cli/src/trello/sync.mjs","packages/cli/src/trello/client.mjs"],"verifiedBy":["packages/cli/test/trello-sync.test.mjs"],"relatedDocs":["docs/test/TRELLO_DOCS_SYNC.md"]},{"id":"TRELLO-CUSTOM-FIELD-001","title":"dotdotgod-view custom field payloads preserve repository entries and conflict rules","sections":["Custom Field Data"],"implementedBy":["packages/cli/src/trello/custom-fields.mjs","packages/cli/src/trello/summary.mjs","packages/cli/src/trello/report.mjs"],"verifiedBy":["packages/cli/test/trello-sync.test.mjs"],"relatedDocs":["docs/arch/TRELLO_DOCS_SYNC.md"]},{"id":"TRELLO-TRACEABILITY-001","title":"Synced markdown traceability is summarized from canonical json dotdotgod blocks only","sections":["Traceability Policy"],"implementedBy":["packages/cli/src/trello/sync.mjs","packages/cli/src/docs/traceability.mjs"],"verifiedBy":["packages/cli/test/trello-sync.test.mjs","packages/cli/test/core.test.mjs"],"relatedDocs":["docs/spec/TRACEABILITY_CONFIG.md"]},{"id":"TRELLO-DUPLICATES-001","title":"Duplicate Trello short links block affected files without Trello API calls","sections":["Duplicate Card Policy"],"implementedBy":["packages/cli/src/trello/sync.mjs"],"verifiedBy":["packages/cli/test/trello-sync.test.mjs"],"relatedDocs":["docs/test/TRELLO_DOCS_SYNC.md"]},{"id":"TRELLO-REPORTS-001","title":"Human reports provide deterministic card status, warning, and action details","sections":["Reports and Status"],"implementedBy":["packages/cli/src/trello/report.mjs","packages/cli/src/trello/sync.mjs"],"verifiedBy":["packages/cli/test/trello-sync.test.mjs"],"relatedDocs":["docs/test/TRELLO_DOCS_SYNC.md"]},{"id":"TRELLO-FAILURES-001","title":"Failure semantics and exit codes distinguish blocked, conflict, api-failed, and usage errors","sections":["Failure Semantics","Exit Codes"],"implementedBy":["packages/cli/src/trello/sync.mjs","packages/cli/src/trello/client.mjs","packages/cli/src/trello/report.mjs"],"verifiedBy":["packages/cli/test/trello-sync.test.mjs","packages/cli/test/trello-workflow.test.mjs"],"relatedDocs":["docs/test/TRELLO_DOCS_SYNC.md"]},{"id":"TRELLO-POWER-UP-001","title":"Power-Up artifact displays dotdotgod-view custom field repository entries","sections":["User Workflow","Custom Field Data","Non-Goals"],"implementedBy":["packages/trello-power-up/src/index.js",".github/workflows/trello-docs-sync.yml"],"verifiedBy":["packages/trello-power-up/test/index.test.mjs","packages/cli/test/trello-workflow.test.mjs"],"relatedDocs":["docs/arch/TRELLO_DOCS_SYNC.md"]}]}
```
