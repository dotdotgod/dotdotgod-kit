...
- `project-initializer-default-config/` — ready: make project initialization create a complete default config from the same canonical policy source used at runtime and by `config init`, including generated offline fallback templates.
