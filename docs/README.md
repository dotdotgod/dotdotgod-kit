...
| `post/` | Local posts about project questions, decisions, experiments, and implementation work. Create one kebab-case directory per post. | `post/README.md` |
...
`docs/plan/`, `docs/post/`, and `docs/archive/` are ignored by git by default. Put local project journals under `docs/post/`, temporary or private reports under `docs/archive/report/`, and tracked reports that should be shared with the repository under `docs/report/`.
