...
- includes default memory areas, traceability policy, and impact ranking policy
...
- generated config contains the default archive-body exclusion and balanced impact ranking preset
